return {
  ...
  keys = {
    ...
    { "<leader>fc", "<cmd>Telescope command_history<CR>", desc = "[c]ommand history" },
    { "<leader>fz", "<cmd>Telescope current_buffer_fuzzy_find<CR>", desc = "fu[z]zy find" },
    { "<leader>ft", "<cmd>Telescope tags<CR>", desc = "[t]ags" },
    { "<leader>fc", "<cmd>Telescope git_bcommits<CR>", desc = "[c]ommits" },
    { "<leader>fs", "<cmd>Telescope lsp_document_symbols<CR>", desc = "[s]ymbols" },
